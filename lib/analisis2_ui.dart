          ...
          children: [
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    boton0 ? Colors.orange : Color(0xFFDFDFDF),
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    boton1 ? Colors.orange : Color(0xFFDFDFDF),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(20.0),
                                ),
                                fixedSize: Size.fromHeight(50.0),
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    boton2 ? Colors.orange : Color(0xFFDFDFDF),
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(20.0),
                                ),
                                fixedSize: Size.fromHeight(50.0),
            ...
            Align(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if ((boton0 || boton1 || boton2) && (botonNo || botonSi)) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
